...
- [PrivTracker](https://privtracker.com/) - Private BitTorrent tracker for everyone. PrivTracker allows to share torrent files just with your fiends, nobody else. Unlike public trackers, it shares peers only within a group which is using the same Announce URL. 
